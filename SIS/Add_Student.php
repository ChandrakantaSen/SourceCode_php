  ...
  <div id="page_content">
    ...
    <div class="right_section">
      <div class="common_content">
        ...
        <hr/>
        <form name="form1" method="post" action="add_student_mailer.php" enctype="multipart/form-data">
		...
		<tr><!--course-->
			<td>
				<div align="right">
					<p><label for="course">Course:&nbsp;</label></p>	 
				</div>
			</td>
			<td>
				<div align="justify">
		...
		<tr><!--mobile-->
			<td height="33">
				<div align="right">
					<p><label for="mob">Mobile Phone:&nbsp;</label></p> 
				</div>
		  </td>
			<td>
				<div align="justify">
