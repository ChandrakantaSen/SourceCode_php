...
<td>
<a href="view_profile.php?id=<?php echo $row->id;?>" title="View Full Details"><i class="fa fa-desktop"></i></a>&nbsp;&nbsp;
   <!-- <a href="update_profile.php?id=<?php echo $row->id;?>" title="View Full Details"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;-->
