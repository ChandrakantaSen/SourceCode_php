...
<head>
 ...
 <div class="form-group">
     ...
     <label class="control-label col-sm-3" for="city">Name:</label>
                 <div class="col-sm-3">
<input style="border:white;" value="<?=$row['name']?>">
                       </div>
 <label class="control-label col-sm-1" for="city">Id:</label>
                
        <div class="col-sm-3">
                     
<input style="border:white;" value="<?=$row['studentid']?>">
             </div>
               </div>
          <br>     
        <div class="form-group">
...
?>
     <div class="form-group">
              <div class="col-sm-offset-5 col-sm-4">
                  <button class="btn btn-danger"><a href="fees.php">Close</a></button>
             </div>
             </div>
    </div>
</form>
