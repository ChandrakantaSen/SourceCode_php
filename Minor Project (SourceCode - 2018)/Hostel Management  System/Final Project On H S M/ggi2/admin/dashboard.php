						...
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-3">
										<div class="panel">
											<div class="panel-body bk-primary text-light" style="background-color:red;">
...
?>
											...
											<a href="manage-students.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-chevron-circle-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
...
?>
											...
											<a href="manage-rooms.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-chevron-circle-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light" style="background-color:#00cd99;">
												<div class="stat-panel text-center">
<?php
...
?>
											...
											<a href="manage-courses.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-chevron-circle-right"></i></a>
										</div>
									</div>
...
?>
                                                    ...
                                                    <div class="stat-panel-number h1 "><?php echo $count2;?></div>
													<div class="stat-panel-title text-uppercase">Visits</div>
												</div>
											</div>
											<a href="manage-courses.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-chevron-circle-right"></i></a>
										</div>
