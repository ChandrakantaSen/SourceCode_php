...
<body>
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="index.php">GGI,Haldia</a>
    ...
    <div id="mainsection">
        <div class="main">
            <a href="index.php?categ=BBA"><button class="btn btn-inverse"><i class=" icon-picture icon-white"></i>BBA</button></a>
            <a href="index.php?categ=BCA"><button class="btn btn-success"><i class=" icon-music icon-white"></i>BCA</button></a>
            <a href="index.php?categ=HM"><button class="btn btn-primary" id="clickme"><i class="icon-film icon-white"></i>BBA in HM</button></a>
            <a href="index.php?categ=HHA"><button class="btn btn-info"><i class="icon-file icon-white"></i>B.Sc. in HHA</button></a>
