      ...
      <div class="w3-white w3-text-grey w3-card-4">
       <!-- <div class="w3-display-container">
        ...
        <div class="w3-container"><br>
            <center><p class="w3-large"><b><i class="fa fa-user-circle fa-fw w3-margin-right w3-xlarge w3-text-teal"></i>Profile</b></p></center><hr>
          <p><i class="fa fa-user fa-fw w3-margin-right w3-large w3-text-teal"></i><?=$n['firstName']?>&nbsp;<?=$n['middleName']?>&nbsp;<?=$n['lastName']?></p>
            <p><i class="fa fa-mars fa-fw w3-margin-right w3-large w3-text-teal"></i><?=$n['gender']?></p>
            <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i><?=$n['city']?></p>
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i><?=$n['email']?></p>
