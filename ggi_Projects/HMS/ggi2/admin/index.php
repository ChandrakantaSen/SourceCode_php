...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/subha.jpg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-5x" style="color:white;">Hostel Management System</h1>
						<div class="row pt-2x pb-3x">
							<div class="col-md-8 col-md-offset-2">

								<form action="" class="mt" method="post">
									<label for="" class="text-uppercase text-sm" style="color:#fff;">Username</label>
