...
$result=mysql_query("SELECT * FROM `order` WHERE `Sl_No`='$Sl_No' ");
echo "<table border='1'>
<tr>
<th>Sl_No</th>
<th>First Name</th>
...
$result=mysql_query("SELECT * FROM `order` WHERE `First Name`='$fname' ");
...
$result=mysql_query("SELECT * FROM `order` WHERE `Company`='$company' ");
...
mysql_close($con);
?>
<a href="memberarea.php">memberarea</a>
</body>
</html>