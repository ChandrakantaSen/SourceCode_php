...
?>
<html>
<head><title>Add Employee Wizard</title></head>
<body>
<form name="add_employee" method="post" action="add_employee_reply.php" enctype="multipart/form-data">
	<table align="center" border="0">
		...
		<tr>
			<th colspan="4">Employee Add Wizard</th>
		</tr>
