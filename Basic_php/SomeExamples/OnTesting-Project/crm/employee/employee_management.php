...
$search_employee_details = "select * from employees ORDER BY id";
...
?>
<html>
<head><title><?php echo $admin_details['username']; ?></title></head>
<body>
<form name="employee_management" method="post" action="add_employee.php">
<table align="center" border="0">
	...
	?>
	<tr align="center">
		<td><a href="employee_details.php?id=<?php echo $employee_details['id']; ?>"><?php echo $employee_details['id']; ?></a></td>
	...
	<tr>
		<td align="center" colspan="3"><input type="submit" name="submit" value="Add New Employee"></td>
	</tr>
</table>
</form>
</body>
