<!--This page contains form to display customer's details-->
<?php
session_start();
require "../include/connection.php";
$id = $_REQUEST['id'];

$search_query = "select * from customers where id = '".$id."'";
...
<form name="employee" method="post">
	<table align="center" border="0">
		...
		<tr>
			<td>Email</td><td><input type="email" name="email_address" value="<?php echo $employee_details['email_address']; ?>" readonly></td>
			<td>Opportunity</td><td><a href="opportunity.php?emp_id=<?php echo $id; ?>&emp_name=<?php echo $employee_details['firstname']." ".$employee_details['lastname']; ?>" style="text-decoration:none;">Show Opportunity</a></td>
		</tr>
		<tr>
			<td colspan="4"><hr></td>
		</tr>
		...
		<tr><td>Business Phone</td><td><input type="number" name="business_phone" value="<?php echo $employee_details['business_phone']; ?>" readonly></td>
			<td colspan="2" rowspan="10"><textarea name="notes" rows="18" cols="34" readonly><?php echo $employee_details['notes']; ?></textarea></td></tr>
