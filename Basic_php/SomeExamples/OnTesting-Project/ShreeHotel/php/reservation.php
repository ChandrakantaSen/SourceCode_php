...
$address = "info@kahinihoteldigha.com";
//$address = "d.sahoo@hexcodetechnologies.com";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "$room";
	echo "<p>Thank you, your reservation has been submitted to us and we'll contact you as quickly as possible to complete your booking.Booking 
	Rooms information inform shortly through mail. </p>";
	echo "</div>";
	echo "</fieldset>";
...
$t=time();
mysqli_query($conn,"INSERT INTO cust_booking (email, check_in, check_out, room_type,adults,children,book_date)VALUES('$email ','$checkin','$checkout ','$room','$adults ','$children','$t')");
exit();
