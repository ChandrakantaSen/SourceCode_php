...
$db_server="easymigcom.netfirmsmysql.com";
$db = "hotelsnlodges"; // your MySQL database name
$mysql_username = "hexcode";  // your MySQL username
$mysql_password = "Tango001";  // your MySQL password

$from_emailaddress = "dbadmin@hexcodetechnologies.com";// your email address to show who the email is from (should be different $to_emailaddress)
$report_emailaddress = "krishanu@hexcodetechnologies.com";//address to send reports, not the backup just details on last backups (can be same as above)
$to_emailaddress = "d.sahoo@hexcodetechnologies.com"; // your email address to send backup files to
...
$time_interval=120;// 3600 = one hour - only allow the backup to run once each hour
