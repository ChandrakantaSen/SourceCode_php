				...
				<div id="content" class="clearfix">
					...
					<table cellpadding="1" cellspacing="1" id="resultTable">
						...
						<?php
							...
							$userid= /*$_SESSION['SESS_MEMBER_ID'];*/$_SESSION['user'];
							$result = mysqli_query($conn,"SELECT * FROM tbl_admin ORDER BY username ASC");
							while($row = mysqli_fetch_array($result))
								{
									...
									echo '<td><div align="center"><a rel="facebox" href="edituser.php?id='.$row['id'].'">edit</a> </div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
