...
{
	$id = $_POST['cancel_id'];
	$update_query="delete from cust_booking where id = '".$id."'";
    ...
    if(!$run_update)
       {
           ...
           die();
			...
			echo "<script>window.location.href='cust_booking.php'</script>";
}
?>
<html>
<head>
			...
			<div id="panel" class="radius">
				...
				<div id="content" class="clearfix">
					...
					<table cellpadding="1" cellspacing="1" id="resultTable">
						<thead>
							<tr>
								<th  style="border-left: 1px solid #C1DAD7">Email</th>
								<th> Check Inn </th>
								<th> Check Out </th>
								<th> Room Type </th>
								<th> Adults</th>
						...
						<?php
							...
							$search_query = "SELECT * from cust_booking order by id desc";
							...
							while($row = mysqli_fetch_array($result))
								{
									...
									?>
										<tr>
											...
											<td><?php echo date("d-n-Y",$t); ?></td>
											<td> <a href="javascript:void(0)" onClick="cancelrecord(<?php echo $row['id']; ?>);">Delete</a></td>
										</tr>
									<?php
								}
							?> 
